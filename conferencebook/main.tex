...
\begin{longtable}{|C{0.15\linewidth}| C{0.1\linewidth}|  C{0.3\linewidth} C{0.0\linewidth} C{0.4\linewidth}|}\hline	
	...
	\CT{8:40--9:00pm}{Nina Ponomarenko}{Argonne National Laboratory}{\hyperlink{Ponomarenko.1}{Structural analysis of platinum nanoclusters accumulated by 
		photosystem I photo-reduction via the X-Ray scattering techniques}}
...
\begin{longtable}{|C{0.15\linewidth}| C{0.1\linewidth}|  C{0.3\linewidth} C{0.0\linewidth} C{0.4\linewidth}|}\hline	
	...
	\KL{9:00--9:40am}{Lauren Ann Metskas}{Purdue University}{TBA}
	...
	\tablebreak{6:00pm}{Dinner}
	\KL{7:30--8:10pm}{David Vinyard}{Louisiana State University}{TBA
	}
	...
	\eventtype{9:00pm}{50th Anniversary Cake, Campfire, and Poster Session }
